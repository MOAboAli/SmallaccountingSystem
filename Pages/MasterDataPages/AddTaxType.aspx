<%@ Page Title="" Language="C#" MasterPageFile="~/BIMasterPage.Master" AutoEventWireup="true" CodeBehind="AddTaxType.aspx.cs" Inherits="BsolutionWebApp.Pages.MasterDataPages.AddTaxType" %>
                ...
                <div class="col-sm-9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                         ...
                         <asp:TextBox ID="TextTaxType" runat="server" class="form-control"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextTaxType" ErrorMessage="RequiredFieldValidator" Font-Bold="True" Font-Italic="False" style="color: #FF0000" ValidationGroup="Go">Required</asp:RequiredFieldValidator>
