<%@ Page Title="" Language="C#" MasterPageFile="~/BIMasterPage.Master" AutoEventWireup="true" CodeBehind="Contact_Type.aspx.cs" Inherits="BsolutionWebApp.Pages.MasterDataPages.Contact_Type" %>
        ...
        <div class="row">
                ...
                <div class="col-sm-9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                                 <label for="ex1">Contact Type Name
