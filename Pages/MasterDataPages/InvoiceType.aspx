<%@ Page Title="" Language="C#" MasterPageFile="~/BIMasterPage.Master" AutoEventWireup="true" CodeBehind="InvoiceType.aspx.cs" Inherits="BsolutionWebApp.Pages.MasterDataPages.InvoiceType" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="nav-justified">
        <tr>
            <td colspan="4">  <h2> <label for="ex1">Invoice Type Page </label></h2></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        ...
        <tr>
            ...
            <td> 
                <div class="col-xs-4">
                    ...
                    Invoice Type Name</label>
                        </div>
                <div class="col-xs-8">
                        <asp:TextBox ID="TextBoxInvoiceType" runat="server" class="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBoxInvoiceType" ErrorMessage="RequiredFieldValidator" ForeColor="Red" ValidationGroup="Go">Required</asp:RequiredFieldValidator>
                        </div>
       ...
       <tr>
           ...
           <td>
               <div class="col-xs-4">
                         <label for="ex1">          PayOrGain                 </label>
                         </div>
                 <div class="col-xs-8">
                     <asp:CheckBox ID="CheckBoxpaygain" runat="server"  />
                              </div></td>
           <td>&nbsp;</td>
           <td>&nbsp;</td>
