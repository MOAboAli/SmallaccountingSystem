        ...
        <table class="nav-justified">
            <tr>
                <td colspan="4">
                   ...
                   <h2> <label for="ex1">Collecting Page </label></h2>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td>
                    ...
                    Invoice No
                     ...
                     <div class="col-xs-8">
                         <asp:DropDownList ID="ddInvoice" runat="server" DataSourceID="SqlDataSource1" DataTextField="Invoice_No" DataValueField="Invoice_Id" ></asp:DropDownList>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="col-xs-8">
                        <asp:DropDownList ID="ddCheque" runat="server" DataSourceID="SqlDataSource2" DataTextField="Cheque_No" DataValueField="Cheque_Id"></asp:DropDownList>
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:CMSConnectionString3 %>" SelectCommand="SELECT [Cheque_Id], [Cheque_No] FROM [Cheque]"></asp:SqlDataSource>
                        </div>
            ...
            <tr>
                ...
                <td>
                    ...
                    Contact</label>
                     ...
                     <div class="col-xs-8">
                         <asp:DropDownList ID="ddContact" runat="server" DataSourceID="SqlDataSource3" DataTextField="Contact_Name" DataValueField="Contact_Id"></asp:DropDownList>
